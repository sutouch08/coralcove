...
<!--  ***********************************   Side menu Start ************************************** -->
	<ul class="nav nav-list">
		...
		<li class=""><a href="#" class="dropdown-toggle"><i class="menu-icon fa fa-tags"></i><span class="menu-text"><?php echo label("sites"); ?></span><b class="arrow fa fa-angle-down"></b></a><!-- First Level -->
			<ul class="submenu">  <!-- Second Level Menu -->
            	<li class=""><a href="<?php echo valid_menu(1,"admin/site"); ?>"><i class="menu-icon fa fa-caret-right"></i><?php echo label("add_edit_site"); ?></a><b class="arrow"></b></li> <!-- Second Level -->	
                <li class=""><a href="<?php echo valid_menu(1,"admin/site_type"); ?>"><i class="menu-icon fa fa-caret-right"></i><?php echo label("add_edit_site_type"); ?></a><b class="arrow"></b></li> <!-- Second Level -->	
